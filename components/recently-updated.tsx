...
const getdata = async ()=>{
    ...
    const response = await fetchDataRedis(`https://sushinimeapi.vercel.app/meta/anilist/recent-episodes?page=1&perPage=30`)
      ...
      {selectedAnime && (
        ...
        <AnimeModal
          ...
          onClose={() => {setSelectedAnime(null); 
            ...
            router.replace(`/recently-updated`, {  scroll: false }) 
          }}
        />
